...
import pandas as pd
def confusion_matrix_plt(conf_matrix_path,output):
    Classes_names=['Apple___Apple_scab',
 'Apple___Black_rot',
 ...
 'Tomato___healthy']
    ...
    conf_matrix=pd.read_csv(conf_matrix_path)
    conf_matrix_df=pd.DataFrame(conf_matrix,columns=Classes_names)
